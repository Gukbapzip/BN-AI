...
LDFLAGS += -lzstd
LDFLAGS += -ldeflate
LDFLAGS += -llerc -llzma -ljpeg -lbz2 -lz
LDFLAGS += -ljbig
LDFLAGS += -lbrotlidec -lbrotlicommon -lharfbuzz -lgraphite2 -lpng16 -lglib-2.0 -lintl -liconv -lws2_32 -lbcrypt -lcrypt32 -lwldap32 -lrpcrt4
