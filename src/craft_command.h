...
class craft_command
{
    public:
        ...
        /// NPC-safe, non-interactive execute: auto-selects the first available
        /// component/tool without showing any UI dialogs. Returns true on success.
        auto npc_execute( const tripoint &new_loc = tripoint_zero ) -> bool;
